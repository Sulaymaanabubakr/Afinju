...
async function seedMore() {
  ...
  const products = [
    ...
    // The following 6 products are placeholders with generic unsplash URLs
    {
      ...
      colors: ['Brown', 'Black'],
      images: [
        { url: '/products/afinju_brown_hero_1773322947363.png', alt: 'Briefcase Hero', publicId: 'local/briefcase-hero' },
        { url: '/products/afinju_brown_detail_1773322964094.png', alt: 'Briefcase Detail', publicId: 'local/briefcase-detail' },
        { url: '/products/afinju_black_lifestyle_1773322925749.png', alt: 'Briefcase Lifestyle', publicId: 'local/briefcase-lifestyle' },
      ],
    ...
    },
    {
      ...
      colors: ['Brown', 'Black'],
      images: [
        { url: '/products/afinju_black_hero_1773322894522.png', alt: 'Loafers Hero', publicId: 'local/loafers-hero' },
        { url: '/products/afinju_black_detail_1773322910632.png', alt: 'Loafers Detail', publicId: 'local/loafers-detail' },
        { url: '/products/afinju_blue_lifestyle_1773322849784.png', alt: 'Loafers Lifestyle', publicId: 'local/loafers-lifestyle' },
      ],
    ...
    },
    {
      ...
      images: [
        { url: '/products/afinju_blue_hero_1773322816739.png', alt: 'Agbada Hero', publicId: 'local/agbada-hero' },
        { url: '/products/afinju_blue_detail_1773322831998.png', alt: 'Agbada Detail', publicId: 'local/agbada-detail' },
        { url: '/products/afinju_black_lifestyle_1773322925749.png', alt: 'Agbada Lifestyle', publicId: 'local/agbada-lifestyle' },
      ],
    ...
    },
    {
      ...
      images: [
        { url: '/products/afinju_red_hero_1773322751923.png', alt: 'Mules Hero', publicId: 'local/mules-hero' },
        { url: '/products/afinju_red_detail_1773322771608.png', alt: 'Mules Detail', publicId: 'local/mules-detail' },
        { url: '/products/afinju_red_lifestyle_1773322801188.png', alt: 'Mules Lifestyle', publicId: 'local/mules-lifestyle' },
      ],
    ...
    },
    {
      ...
      images: [
        { url: '/products/afinju_brown_hero_1773322947363.png', alt: 'Cap Hero', publicId: 'local/cap-hero' },
        { url: '/products/afinju_brown_detail_1773322964094.png', alt: 'Cap Detail', publicId: 'local/cap-detail' },
        { url: '/products/afinju_blue_lifestyle_1773322849784.png', alt: 'Cap Lifestyle', publicId: 'local/cap-lifestyle' },
      ],
    ...
    },
    {
      ...
      colors: [],
      images: [
        { url: '/products/afinju_black_hero_1773322894522.png', alt: 'Perfume Hero', publicId: 'local/perfume-hero' },
        { url: '/products/afinju_black_detail_1773322910632.png', alt: 'Perfume Detail', publicId: 'local/perfume-detail' },
        { url: '/products/afinju_red_lifestyle_1773322801188.png', alt: 'Perfume Lifestyle', publicId: 'local/perfume-lifestyle' },
      ],
