  ...
  return (
    <LegalPage title="Terms of Service">
      <Section title="1. Acceptance of Terms">
        By placing an order on Afínjú, you agree to be bound by these terms. If you do not agree, please do not use our website or services.
      </Section>
      ...
      <Section title="5. Delivery">
        Delivery timelines are estimates and may be affected by logistics conditions outside our control. Afínjú is not liable for delays caused by third-party courier services, though we will always assist in resolution.
      </Section>
      <Section title="6. Intellectual Property">
        All content on this website, including the Afínjú name, logo, photography, and copy, is the exclusive property of Afínjú and may not be reproduced, distributed, or used without written permission.
      </Section>
  ...
  return (
    <LegalPage title="Shipping & Returns">
      ...
      <Section title="Delivery">
        Delivery is included in the price of every Afínjú Authority Set order. All deliveries are handled through trusted Nigerian logistics partners.
      </Section>
      <Section title="Returns Policy">
        As every Afínjú set is made to your specifications (colour, shoe size, head size), we do not accept returns based on change of preference or mind. However, if your item arrives damaged, defective, or does not match your confirmed order specifications, we will replace it at no cost. Contact us within 48 hours of delivery with photographic evidence.
      </Section>
    ...
    <div className="min-h-screen">
      <section className="bg-afinju-black text-afinju-cream py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="font-sans text-sm text-afinju-cream/40 mt-3">Afínjú · Last updated March 2025</p>
        </div>
      </section>
